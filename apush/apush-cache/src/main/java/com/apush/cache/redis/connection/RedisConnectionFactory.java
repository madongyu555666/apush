package com.apush.cache.redis.connection;
...
public class RedisConnectionFactory {
    ...
    private int timeout = Protocol.DEFAULT_TIMEOUT;//2000
    private String password;

    private String sentinelMaster;//哨兵的master
    private List<RedisNode> redisServers;
    private boolean isCluster = false;
    private int dbIndex = 0;
    //一个JedisShardInfo类，里面包含了jedis服务器的一些信息,可以获取服务器信息
