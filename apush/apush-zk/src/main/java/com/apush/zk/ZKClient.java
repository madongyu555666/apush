...
public class ZKClient extends BaseService {
    ...
    private Map<String, String> ephemeralNodes = new LinkedHashMap<>(4);//短期节点
    private Map<String, String> ephemeralSequentialNodes = new LinkedHashMap<>(1);//短期顺序节点
